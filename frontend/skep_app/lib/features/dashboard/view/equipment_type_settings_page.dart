...
// TODO: Replace local mock data with backend API when equipment-type settings endpoint is available.
// Currently no dedicated endpoint exists for equipment type configurations.
// Candidate: GET/POST /api/equipment/types (not yet in ApiEndpoints)
